...
<div id="divTriagem" class="container py-2">
   ...
   <form enctype="multipart/form-data" method="post" id="frmImportarChamado" class="mb-5">
      ...
      <div class="text-right my-3"><button id="btnValidaEquip" type="button" class="btn btn-success" disabled><i class="fa fa-check"></i> Confirmar</button>
        <button type="button" id="btnAlteraEquip" class="btn btn-info" disabled><i class="fas fa-pencil-alt"></i></button>
      </div>
