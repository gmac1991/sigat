...
$route['chamado/email_solicitante/(:num)'] = 'interacao/busca_email_solicitante/$1';
$route['chamado/busca_email/(:any)'] = 'interacao/busca_email_ldap/$1';
...
$route['listar_servicos_chamado/(:num)'] = 'chamado/listar_servicos_chamado/$1';
$route['atualizar_servicos_chamado/(:num)'] = 'chamado/atualizar_servicos_chamado/$1';
$route['listar_servicos/(:num)'] = 'chamado/listar_servicos/$1';
$route['excluir_servico/(:num)'] = 'chamado/excluir_servico/$1';
$route['equipamento/(:any)'] = 'equipamento/index/$1';
$route['equipamento/controller/registra_lacre'] = 'equipamento/registra_lacre';
$route['inservivel/'] = 'inservivel/index/';
$route['inservivel/(:num)'] = 'inservivel/visualizarDetalhado/$1';
$route['gerar_termo/(:num)'] = 'inservivel/gerarTermo/$1';
$route['inservivel/(:num)'] = 'inservivel/visualizarDetalhado/$1';
$route['listar_detalhado/(:num)'] = 'inservivel/listar_detalhado/$1';
